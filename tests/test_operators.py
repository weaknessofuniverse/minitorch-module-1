...
def test_symmetric() -> None:
    ...
    """
    for x, y in [(2.0, 3.0), (-1.5, 4.0), (0.0, 7.0), (10.0, -0.25)]:
...
def test_distribute() -> None:
    ...
    """
    for x, y, z in [(1.0, 2.0, 3.0), (-4.0, 0.5, 2.5), (10.0, -3.0, -1.0)]:
...
def test_other() -> None:
    ...
    for x in [-5.0, -1.0, 0.5, 3.0, 50.0]:
        # negation is an involution, and relu is idempotent
        assert neg(neg(x)) == x
        assert relu(relu(x)) == relu(x)
